...
while True:
    ...
    if choice == "1":
        ...
        time.sleep(0.5)
        os.system("cd $home && rm -rf B64 && apt install python -y && apt install git -y && apt install ruby -y && gem install lolcat && git clone https://github.com/D-MythX/B64 && cd B64 && clear")
